    ...
    return (
        <motion.div
            ...
            <div className='flex items-center gap-2 sm:gap-4'>
                ...
                <span className='dark:text-white text-black text-xl sm:hidden ' onClick={() => setSidebarOpen(true)}><i className=" ri-menu-3-line"></i></span>
